 ...
 * @author USER
 */
public class TrasladoSaldoForm extends javax.swing.JFrame {
    ...
    public TrasladoSaldoForm() {
        ...
        getContentPane().setBackground(new Color(224, 255, 255)); // Cyan claro
        ...
        tblHistorial.getTableHeader().setBackground(new Color(0, 139, 139)); // cyan oscuro
        ...
        estilizarBoton(btnRealizarTraslado, new Color(0, 153, 153));
        estilizarBoton(btnCancelar, new Color(200, 200, 200));
        estilizarBoton(btnCerrar, new Color(255, 102, 102));

        // Estilo a campos (si deseas también aplicar)
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Traslado de Saldos");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            new TrasladoSaldoForm().setVisible(true);
        });
